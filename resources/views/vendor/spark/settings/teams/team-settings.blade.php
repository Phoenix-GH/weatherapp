                    ...
                    <div class="panel-body">
                        <div class="spark-settings-tabs">
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                <!-- Owner Settings -->
                                <li role="presentation" class="active">
                                    <a href="#rentpost" aria-controls="owner" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-edit"></i> RentPost
                                    </a>
                                </li>

                                <li role="presentation" class="active">
                                    <a href="#rentmanager" aria-controls="owner" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-edit"></i> RentManager
                                    </a>
                                </li>

                                <li role="presentation" class="active">
                                    <a href="#add-integration" aria-controls="owner" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-plus"></i> Add More
                                    </a>
                                </li>
            ...
            <div class="col-md-8">
                <div class="tab-content">
                    ...
                    @endif
                        ...
                        <div role="tabpanel" class="tab-pane" id="rentpost">
                            <div v-if="user && team">
                                @include('spark::settings.api_integration.rentpost')
                            </div>
                        </div>

                        <div role="tabpanel" class="tab-pane" id="rentmanager">
                            <div v-if="user && team">
                                @include('spark::settings.api_integration.rentmanager')
                            </div>
                        </div>

                        <div role="tabpanel" class="tab-pane" id="add-integration">
                            <div v-if="user && team">
                                @include('spark::settings.api_integration.add-integration')
                            </div>
                        </div>
                </div>
            </div>
