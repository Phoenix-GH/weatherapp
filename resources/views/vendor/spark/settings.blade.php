...
<spark-settings :user="user" :teams="teams" inline-template>
    <div class="spark-screen fluid-container">
        <div class="row">
            <div class="setting-heading">
                <span class="profile-image">
                    <img src="https://www.gravatar.com/avatar/ae76903….jpg?s=200&d=mm"/>
                </span>
                Settings
            </div>
            <!-- Tabs -->
            <div class="col-md-2 setting-sidebar">
                            ...
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-edit"></i>Individual Profile
                                    </a>
                                </li>
                                   ...
                                   {{--  <li role="presentation">
                                    ...
                                    <li role="presentation">
                                        <a href="#notification" aria-controls="notification" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-history"></i>Notifications Settings
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="tab-content">
                  ...
                  <!-- Invoices -->
                        <div role="tabpanel" class="tab-pane" id="notification">
                            @include('spark::notificationSettings.notification-settings')
                        </div>
                </div>
            </div>
        </div>
