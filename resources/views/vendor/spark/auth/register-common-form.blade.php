<form class="form-horizontal" role="form">
    ...
    <!-- Type -->
    <div class="form-group" :class="{'has-error': registerForm.errors.has('account_type')}">
        <label class="col-md-4 control-label">I am a ...</label>

        <div class="col-md-6">
            <select class="form-control" name="account_type" v-model="registerForm.account_type">
                @widget('accountTypeDropdown')
            </select>

            <span class="help-block" v-show="registerForm.errors.has('account_type')">
                @{{ registerForm.errors.get('account_type') }}
            </span>
        </div>
    </div>
