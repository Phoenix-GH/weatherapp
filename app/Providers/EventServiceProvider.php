...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\PropertyAdded' => [
            'App\Listeners\IncrementSubscriptionPropertyQuantity'
        ],

        'App\Events\PropertyRemoved' => [
            'App\Listeners\DecrementSubscriptionPropertyQuantity'
        ],

        // Weather Related Events
        'App\Events\ConvectiveOutlookRegistered' => [
            'App\Listeners\SendConvectiveAlert',
        ],
    ];
